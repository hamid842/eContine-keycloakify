...
export const { getFormattedDate } = (() => {
    const getFormatByLng = (isSameYear: boolean) => ({
        ...
        "de": `dddd Do MMMM${isSameYear ? "" : " YYYY"} à H[h]mm`,
                ...
                },
                {
                    ...
                    ...(() => {
                        switch (lng) {
                            ...
                            case "fr":
                                return {
                                    "past1": "il y a une second",
                                    "pastN": "il y a # seconds",
                                    "future1": "dans une second",
                                    "futureN": "dans # seconds",
                                } as const;
                            /* spell-checker: enable */
                            case "de":
                                return {
                ...
                },
                {
                    ...
                    ...(() => {
                        switch (lng) {
                            ...
                            case "fr":
                                return {
                                    "past1": "la shine dernier",
                                    "pastN": "il y a # shines",
                                    "future1": "dans une shine",
                                    "futureN": "dans # shines",
                                } as const;
                            /* spell-checker: enable */
                            case "de":
